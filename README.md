...
Supports configurable AI provider via config.json:

* OpenAI API
* Local Ollama server

The LLM assists in command understanding and conversational responses.
...
Replace your_openai_api_key with a valid API key.

### 6.3 Ollama Configuration (Local LLM)
...
Desktop AI Orchestrator - Bringing structured AI automation to the desktop environment.
